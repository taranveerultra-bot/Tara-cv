...
export const recruiterQuestions: RecruiterQuestion[] = [
    ...
    },
    {
        ...
        answer: [
            ...
            "I value time and do not waste it. I look for better ways to get work done and keep improving the systems around me. You can expect me to be straightforward, accountable and honest about whether something is working. That is why you should hire me.",
        ],
    },
];
