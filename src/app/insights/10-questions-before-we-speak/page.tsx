...
export const metadata: Metadata = {
    title: "10 Questions You Might Have Before We Speak",
    description: "Straight answers from Taran about experience, work rights, availability and approach to work.",
    alternates: { canonical: "/insights/10-questions-before-we-speak" },
};
...
export default function RecruiterQuestionsPage() {
    return (
        <>
            <article>
                <header className="bg-primary pb-20 pt-36 sm:pb-28 sm:pt-44">
                    <Container>
                        <Link
                            href="/insights"
                            className="inline-flex items-center gap-2 text-sm font-bold uppercase tracking-[0.14em] transition-opacity hover:opacity-60"
                        >
                            <HiArrowLeft aria-hidden="true" />
                            All insights
                        </Link>
                        <p className="mt-10 text-sm font-bold uppercase tracking-[0.18em]">Work and availability</p>
                        ...
                        <p className="mt-8 max-w-3xl text-xl leading-relaxed sm:text-2xl">
                            Straight answers about my experience, work rights, availability and the way I approach
                            work.
                        </p>
                    </Container>
                </header>
